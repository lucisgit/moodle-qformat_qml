...
$string['blankmultiquestionhint'] = "   (Separate answers with a comma and no spaces e.g. answer1,answer2,answer3...)";
$string['contenttypenotset'] = "<strong>Notice</strong>: No content type set in question header. Defaulting to HTML <br >" . PHP_EOL;
